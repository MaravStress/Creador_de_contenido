  ...
  return (
    <div className="container py-4">
      ...
      <div className="d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom" style={{ borderColor: 'rgba(255, 255, 255, 0.08)' }}>
        ...
        <button className="flat-btn py-2 px-3 fs-6 d-flex align-items-center gap-2">
        ...
        <div className="col-12 col-md-4 col-lg-3">
          <div className="glass-panel p-3 text-start">
            ...
            <button
              ...
              className="w-100 py-2 rounded-3 text-light border-0 d-flex align-items-center justify-content-center gap-1"
              style={{
                background: 'rgba(255, 255, 255, 0.05)',
